...
_$AiChatSettingsImpl _$$AiChatSettingsImplFromJson(Map<String, dynamic> json) => _$AiChatSettingsImpl(
...
Map<String, dynamic> _$$AiChatSettingsImplToJson(_$AiChatSettingsImpl instance) => <String, dynamic>{
