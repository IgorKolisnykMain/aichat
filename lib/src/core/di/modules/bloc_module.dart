...
//   // @factoryMethod
//   // SplashController splashBloc(AuthRepository authRepository, UserRepository userRepository, AiTutorRepo aiTutorRepo) =>
//   //     SplashController(authRepository, userRepository, aiTutorRepo);
