...
class CheckoutSession {
  ...
  factory CheckoutSession.fromMap(Map<String, dynamic> map) {
    ...
    if (client == 'mobile') {
      final paymentIntentClientSecret = map['paymentIntentClientSecret'] as String?;
      final ephemeralKeySecret = map['ephemeralKeySecret'] as String?;
      final customer = map['customer'] as String?;
      if (paymentIntentClientSecret != null && ephemeralKeySecret != null && customer != null) {
