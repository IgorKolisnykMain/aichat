...
import 'package:aichat/src/features/payment/domain/payment.dart';
...
class PaymentsRepository {
  ...
  static String paymentPath(UserID uid, String paymentId) => 'stripe_customers/$uid/payments/$paymentId';
  ...
  DocumentReference<Payment?> _paymentRef(UserID uid, String paymentId) => _firestore
      .doc(paymentPath(uid, paymentId))
      .withConverter(
        fromFirestore: (doc, _) {
          final data = doc.data();
