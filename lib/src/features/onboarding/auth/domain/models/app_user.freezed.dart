...
class _$AppUserCopyWithImpl<$Res, $Val extends AppUser> implements $AppUserCopyWith<$Res> {
  ...
  @override
  $Res call({Object? uid = null, Object? email = freezed}) {
    return _then(
      _value.copyWith(
            uid: null == uid
                ? _value.uid
...
class _$AppUserImpl implements _AppUser {
  _$AppUserImpl({required this.uid, required this.email});
...
abstract class _AppUser implements AppUser {
  factory _AppUser({required final String uid, required final String? email}) = _$AppUserImpl;
