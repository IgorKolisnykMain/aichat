...
class GoldenRobot {
  ...
  Future<void> loadRobotoFont() async {
    final lexendBold = rootBundle.load('assets/fonts/Lexend-Bold.ttf');
    final lexendRegular = rootBundle.load('assets/fonts/Lexend-Regular.ttf');
    final plusJakartaSansBold = rootBundle.load('assets/fonts/PlusJakartaSans-Bold.ttf');
    final plusJakartaSansMedium = rootBundle.load('assets/fonts/PlusJakartaSans-Medium.ttf');
    final plusJakartaSansSemiBold = rootBundle.load('assets/fonts/PlusJakartaSans-SemiBold.ttf');
    final plusJakartaSansRegular = rootBundle.load('assets/fonts/PlusJakartaSans-Regular.ttf');

    final lexendFontLoader = FontLoader('Lexend')
      ..addFont(lexendBold)
      ..addFont(lexendRegular);
    await lexendFontLoader.load();

    final plusJakartaSansFontLoader = FontLoader('PlusJakartaSans')
      ..addFont(plusJakartaSansBold)
      ..addFont(plusJakartaSansMedium)
      ..addFont(plusJakartaSansSemiBold)
      ..addFont(plusJakartaSansRegular);
    await plusJakartaSansFontLoader.load();
  }
      ...
      await tester.runAsync(() async {
        for (final match in matches) {
          ...
          if (decoration?.image != null) {
            await precacheImage(decoration!.image!.image, match);
          }
        }
      });
    }
